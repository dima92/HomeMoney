...
using Authorization.Project.Core.Models;
using Authorization.Project.Core.Providers;
using Authorization.Project.Core.Results;
using System.Web.Http.Cors;
using Newtonsoft.Json;

namespace Authorization.Project.Core.Controllers
{
    // CORS
